...
import com.iti.cloud4all.nodejs.requests.*;
...
public abstract class RequestMessage extends Message {
    ...
    private final static HashMap _requestMessages;
    ...
    static {
        ...
        _requestMessages.put(UserProfile.class.getSimpleName(), UserProfile.class);
        _requestMessages.put(EnvironmentProfile.class.getSimpleName(), EnvironmentProfile.class);
        _requestMessages.put(RunRules.class.getSimpleName(), RunRules.class);
    }
